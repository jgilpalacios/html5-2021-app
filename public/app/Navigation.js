...
const swipeTo = (getTo = '#menu_page') => {
     ...
     */
    //swiper.slideTo(...);
    //se busca el índice del array secciones swper_item y se navea a ese índice 
...
const navigationTo = (getTo, animationType) => {
    ...
    switch (animationType) {
        ...
        /**
         * Desde la pantalla menu al juego (principal)
         */
        case 'menu_to_game':
         ...
         /**
         * Desde la pantalla de juego finalizado al menu
         */
          case 'game_out':
...
const popUpToggle = (getTo, animationType) => {
    ...
    switch (animationType) {
        ...
        case 'pause_modal':
            ...
            //hemos llevado la promesa a la funcion en lugar de aqui
            break;
        
        /**
         * Se cierra el popup y se vuelve al juego
         */
        case 'resume_modal':
            animation_PopupContinue(getTo);
            break;
        ...
        /**
         * Se abre el popup para confirmar o no la salida del juego
         */
        ...
        /**
         * Se cierra el popup para cancelar y volver al juego
         */
